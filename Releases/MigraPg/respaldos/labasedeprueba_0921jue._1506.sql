...
CREATE TABLE public.retencion (
    ...
    description character varying(255),
    baseamount numeric DEFAULT 12 NOT NULL,
    baseamountref numeric DEFAULT 12 NOT NULL,
    impamount numeric DEFAULT 12 NOT NULL,
    impamountref numeric DEFAULT 12 NOT NULL,
    totalamount numeric DEFAULT 12 NOT NULL,
    totalamountref numeric DEFAULT 12 NOT NULL,
