...
CREATE TABLE public.org (
    ...
    name character varying(60) NOT NULL,
    org_id character varying(36) DEFAULT NULL::character varying NOT NULL,
    social_name character varying(33),
    value character varying(40) DEFAULT NULL::character varying NOT NULL,
    current_status character varying(33) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE public.retencion (
    retencion_id character varying(200) NOT NULL,
    isactive character(1) DEFAULT 'Y'::bpchar NOT NULL,
    created timestamp without time zone DEFAULT now() NOT NULL,
    createdby character varying(36) NOT NULL,
    updated timestamp without time zone DEFAULT now() NOT NULL,
    ...
    bpartner_id character varying(36) NOT NULL,
    documentno text DEFAULT NULL::character varying,
    nro_documento_fiscal character varying(60) NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
    baseamount numeric DEFAULT 43 NOT NULL,
    baseamountref numeric DEFAULT 34 NOT NULL,
    impamount numeric DEFAULT 43 NOT NULL,
    impamountref numeric DEFAULT 34 NOT NULL,
    totalamount numeric DEFAULT 43 NOT NULL,
    totalamountref numeric DEFAULT 43 NOT NULL,
