...
CREATE TABLE public.org (
    ...
    org_id text DEFAULT NULL::character varying NOT NULL,
    social_name character varying(33),
    value character varying(33) DEFAULT NULL::character varying NOT NULL,
    current_status character varying(33) DEFAULT ''::character varying NOT NULL,
    vencimiento timestamp without time zone,
    parent_org_id character varying(33)
);
