...
CREATE TABLE public.retencion (
    ...
    description character varying(255),
    baseamount numeric DEFAULT 40 NOT NULL,
    baseamountref numeric DEFAULT 40 NOT NULL,
    impamount numeric DEFAULT 40 NOT NULL,
    impamountref numeric DEFAULT 40 NOT NULL,
    totalamount numeric DEFAULT 40 NOT NULL,
    totalamountref numeric DEFAULT 40 NOT NULL,
