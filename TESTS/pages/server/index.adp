...
if { [ns_queryget "tclproc"] != "" } {
    ...
    ns_puts "
<h2>Tcl Proc: $tclproc</h2><BR>

<blockquote>
<tt><b>$tclproc [info args $tclproc]</b></tt><pre>[ns_quotehtml $procbody]</pre></blockquote><BR></body></html>"    
...
$Header: /cvsroot/aolserver/aolserver/scripts/tests/nstelemetry,v 1.2 2000/09/25 22:04:47 kriston Exp $
